...
export default function Home() {
  ...
  async function fetchProducts(){
    await axios.get("https://ecommerce-application-m853.onrender.com/api/product")
      .then((res)=>{
        console.log(res)
  ...
  async function addCart(productId){
    ...
    try{
      await axios.post("https://ecommerce-application-m853.onrender.com/api/cart/add",{productId},{

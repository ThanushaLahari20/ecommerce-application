...
export default function Cart() {
    ...
    async function fetchCartProducts() {
        await axios.get("https://ecommerce-application-m853.onrender.com/api/cart", {
    ...
    async function removeFromCart(productId){
        try{
            await axios.delete(`https://ecommerce-application-m853.onrender.com/api/cart/remove/${productId}`,{
                headers:{Authorization:`Bearer ${user.token}`}
            })
            .then((res)=>{
